/* 310T2 Exam Simulator, Application Logic */

const ACCESS_CODE  = "310T29000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "310t2_exam_state_v1";
const SIM_Q_COUNT  = 135;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "engines_and_supporting_systems": "Engines and Supporting Systems", "air_and_brake_systems": "Air and Brake Systems", "electrical_and_electronic_systems": "Electrical and Electronic Systems", "drive_trains": "Drive Trains", "steering_chassis_suspensions_tires_wheels_and_hubs": "Steering Chassis Suspensions Tires Wheels and Hubs", "cabs_and_trailers": "Cabs and Trailers", "climate_control_and_hydraulic_systems": "Climate Control and Hydraulic Systems", "hybrid_and_electric_vehicles": "Hybrid and Electric Vehicles"};  // maps domain key -> human-readable label for display
